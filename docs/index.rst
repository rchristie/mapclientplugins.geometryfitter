...
1. Value < 0.0 specifies proportion of maximum projection length to exclude, e.g. -0.1 excludes data points within 10% of the maximum. Values are clamped to >= -1.0.
